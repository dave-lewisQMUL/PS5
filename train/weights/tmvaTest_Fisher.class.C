...
Creator        : lewis
Date           : Wed Nov 13 11:12:16 2013
Host           : Linux heppc041 2.6.32-5-amd64 #1 SMP Sun Sep 23 10:07:46 UTC 2012 x86_64 GNU/Linux
Dir            : /common/users/lewis/comp-probs/PS5/train
...
NVar 3
x                             x                             x                             x                                                               'F'    [-2.83613920212,3.88070130348]
y                             y                             y                             y                                                               'F'    [-1.85786509514,3.81804180145]
z                             z                             z                             z                                                               'F'    [8.58446583152e-07,0.999821841717]
NSpec 0
...
class ReadFisher : public IClassifierReader {
 ...
 public:
   ...
   {      
      ...
      fVmin[0] = -2.83613920211792;
      fVmax[0] = 3.88070130348206;
      fVmin[1] = -1.85786509513855;
      fVmax[1] = 3.81804180145264;
      fVmin[2] = 8.58446583151817e-07;
      fVmax[2] = 0.999821841716766;
...
{
   fFisher0 = 0.559909832626;
   fFisherCoefficients.push_back( -0.223408527632 );
   fFisherCoefficients.push_back( -0.404748076294 );
   fFisherCoefficients.push_back( -0.295335041646 );
